        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-sm rounded-xl bg-card border border-border p-6 shadow-xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95">
          ...
          <div className="mb-5">
            ...
            <p className="text-xs text-muted-foreground/60 mt-1.5">
              This name will appear on your future forum posts and comments.
            </p>
          </div>
          ...
          <div className="flex gap-3 justify-end">
            <button
              ...
              className="h-9 px-4 rounded-lg border border-border bg-background hover:bg-accent/50 text-sm font-medium transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className="h-9 px-4 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
            >
              {isSaving ? (
                <>
